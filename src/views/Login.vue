<template>
    <div class="login-wrap">
        <div class="ms-login">
            <div class="ms-title">软件安全管理系统</div>
...
<!--                <el-form-item prop="computerId">-->
<!--                    <el-input type="" placeholder="" v-model="param.computerId"-->
<!--                              @keyup.enter="submitForm()">-->
<!--                        <template #prepend>-->
<!--                            <el-button icon="el-icon-lx-copy"></el-button>-->
<!--                        </template>-->
<!--                    </el-input>-->
<!--                </el-form-item>-->
                <div class="login-btn">
...
<script>
    ...
    export default {
        setup() {
            ...
            const dropParams = ['部门1', '部门2', '部门3', '部门4']
            const rules = {
                username: [
                    {
                        required: true,
            ...
            const verifyName = async () => {
                await verify(param.username).then((res)=>{
                    console.log("71###"+res)
                   re.value = res
                })
            }
